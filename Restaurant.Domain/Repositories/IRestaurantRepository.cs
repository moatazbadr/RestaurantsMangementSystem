...
public interface IRestaurantRepository
{
    ...
    public Task<(IEnumerable<RestaurantsEntity>, int)> GetAllMatchingAsync(string ? searchPhrase,int pageNumber,int pageSize,string? SortBy ,SortDirection sortDirection );
